...
class NameGenDB
{
     ...
     */
    public function __construct($sCLTRID, $credential, $sKey, $nMaxResults, $bExcludeTaken, $sTLDs, $bAddPrefix, $bAddSuffix, $bAddDashes, $bAddRelated, $bAdvancedSplit, $bBaseOnTop)
    {
    ...
    /**
     * @param string $sCLTRID
     * @return \cloudposse\wild_west_reseller_api\NameGenDB
     */
