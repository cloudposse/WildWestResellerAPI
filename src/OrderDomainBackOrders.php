...
class OrderDomainBackOrders
{
    ...
    /**
     * @var ArrayOfDomainBackOrder $items
     */
     ...
     * @param ArrayOfDomainBackOrder $items
     * @param string $sROID
     */
    ...
    /**
     * @param string $sCLTRID
     * @return \cloudposse\wild_west_reseller_api\OrderDomainBackOrders
     */
